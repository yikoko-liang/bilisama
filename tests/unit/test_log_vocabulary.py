...
KNOWN_EVENTS: frozenset[str] = frozenset(
    {
        ...
        "voice_gate.marker_midway",
        "voice_gate.marker_unbracketed",
        "voice_gate.mode_changed",
        "voice_gate.passed",
        "voice_gate.skipped",
        "voice_gate.unattached",
        ...
        "uplink_record.capped",
        "uplink_record.failed",
        "uplink_record.started",
