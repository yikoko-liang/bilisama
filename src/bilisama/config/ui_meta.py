...
UI_META: dict[str, FieldMeta] = {
    ...
    "audio.noise_sensitivity": FieldMeta(
        label="环境噪音灵敏度",
        hint="数值低时更不容易误触发；数值高时更容易听见小声说话",
        audience=Audience.STREAMER,
        reload=Reload.LIVE,
        widget="slider",
        group="音频",
    ...
    "interaction.danmaku.window_s": FieldMeta(
        label="弹幕整理间隔",
        hint="积累这段时间的普通弹幕后挑一条回复",
        unit="s",
        audience=Audience.STREAMER,
        reload=Reload.LIVE,
        group="互动",
    ...
    "interaction.entry_welcome": FieldMeta(label="入房欢迎", group="互动", order=11),
    ...
    "persona.profile": FieldMeta(
        label="Mia 人设方案",
        hint="只替换 Mia 的提示词，形象、音色和语音连接保持不变",
        widget="segmented",
        audience=Audience.STREAMER,
        reload=Reload.LIVE,
        group="人设",
    ...
    "room.stream_intro": FieldMeta(
        label="直播主题简介",
        hint="告诉刚进来的观众这场直播在做什么；保存后立即参与欢迎文案",
        widget="textarea",
        audience=Audience.STREAMER,
        reload=Reload.LIVE,
        group="直播间",
